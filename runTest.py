        ...
        for method in methods:
            ...
            for k in xrange(5,8):
                ...
                for i in xrange(ntrial):
                    ...
                    ts = time.time()
                    idx,selectionOA = model.selection(method,xtrain,ytrain,criterion=criterion,stopMethod='maxVar',delta=1.5,maxvar=k,nfold=5,balanced=True,decisionMethod='inv',random_state=1)
