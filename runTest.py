    ...
    for criterion in criterions:
        for method in methods:
            ...
            for i in xrange(ntrial):
                ...
                ts = time.time()
                idx,selectionOA = model.selection(method,xtrain,ytrain,criterion=criterion,stopMethod='maxVar',delta=1.5,maxvar=maxVar,nfold=5,balanced=True,decisionMethod='inv',random_state=1)
